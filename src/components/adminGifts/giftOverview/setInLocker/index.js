...
export default function SetInLocker({ lockerState, setLockerState }) {
    ...
    async function getImage(id) {
        ...
        let data = { id: id };
        axios.post(`${url}api/v1/gifts/getGiftFromId`, data, config)
    ...
    async function getProductImage(productID) {
        let data = { productID };
        axios.post(`${url}api/v1/frontend/getProductById`, data)
    ...
    async function handleSubmissionEvent() {
        ...
        axios.post(`${url}api/v1/gifts/setGiftInLocker`, data, config)
